...
#    Updated: 2026/03/16 19:19:09 by aosset-o         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME = cub3D
SRC = src/main.c src/parse/parse_store.c src/parse/parse_free.c src/parse/parse_init.c \
src/parse/parse_utils.c src/parse/parse_check.c
