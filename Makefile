...
#    Updated: 2026/03/12 17:24:24 by aosset-o         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME = cub3D
SRC = src/main.c src/parse/parse_store.c src/parse/parse_free.c src/parse/parse_init.c src/parse/parse_utils.c
